...
const UserOrderDetails = ({ params }: { params: { id: string } }) => {
 ...
 const handleReviewSubmit = async () => {
  ...
  try {
    ...
    const errorMessage = err instanceof Error ? err.message : "An error occurred while submitting the review";
  ...
  return (
    <Container className="max-w-screen-2xl mx-auto pt-16 px-8 lg:px-24 flex-grow">
