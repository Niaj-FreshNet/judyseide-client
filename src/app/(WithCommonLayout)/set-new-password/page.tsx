...
import emailValidationSchema from "@/src/schemas/email.schema";
                ...
                <div className="w-full md:w-1/2 p-12 flex justify-center items-center">
                    <div className="w-full">
                        <div className="text-center">
                            <h2 className="text-4xl font-bold text-orange-500 mb-4">Set new password</h2>
                        </div>
                        ...
                        <div className="px-8 pt-16 pb-16  rounded-md shadow-2xl border border-gray-50 space-y-6">
                            ...
                            >
                                <div className="space-y-4">
                                    ...
                                    <JudyInput label="Confirm Password" name="confirmPassword" size="lg" type="password" />
                                </div>
